...
function App() {
  ...
  const handleRegenerateSection = async (sectionId: string) => {
    ...
    // Store current note format
    const currentFormat = noteFormat;
    ...
    try {
      ...
      // Build a format-specific prompt for the section
      const sectionPrompt = `Please regenerate only the following section of the clinical documentation using the ${currentFormat.toUpperCase()} format. Return ONLY the content for this section, without the section header:\n\n${section.heading}`;
